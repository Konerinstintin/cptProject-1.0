...
function result() {
    document.getElementById("score").innerHTML = (((localStorage.clickcount + 1) / 12) * 100).toFixed(0) + "%";
    var desision = (((localStorage.clickcount + 1) / 12) * 100).toFixed(0);

    if (desision < 80 || desision == 0) {
        ...
        dsocument.getElementById("result").innerHTML = ("Sorry but you have scored less than the required amount to unlock the online quiz please click &#34;Reset&#34; and try agian");
    } else {
        document.write("Error press reset");
    }
}
