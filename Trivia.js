...
function result() {
	...
	var str = "Online Quiz";
	var result = str.link("https://konerinstintin.github.io/cptProject/Trivia.html");
	...
	if (desision < 80) {
		...
		document.getElementById("result").innerHTML = ("Congradulations you have scored more than 80% on the quiz, you can now continue to the next online quiz<br><br>" + result);
	} else if (desision > 100) {
